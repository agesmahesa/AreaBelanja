            ...
            <div class="row contentForm">
                ...
                <div class="col-sm-12 col-md-6 col-lg-6">
                  ...
                  <form action="" method="POST">
                    ...
                    <button type="submit" class="btn btn-warning w-100 text-light" name="submit">LOGIN</button>
                    <a href="index.php" type="button" class="btn btn-outline-warning w-100 mt-5">MENU PELANGGAN</a>
                  </form>
                </div>
                <?php
